...
import fabled.quitewhisper.domain.HotkeyEvent
...
class EngineDictationRepository(
    ...
    private fun fabled.quitewhisper.data.engine.HotkeyEvent.toDomain(): HotkeyEvent = when (this) {
        fabled.quitewhisper.data.engine.HotkeyEvent.Pressed -> HotkeyEvent.Pressed
        fabled.quitewhisper.data.engine.HotkeyEvent.Released -> HotkeyEvent.Released
        is fabled.quitewhisper.data.engine.HotkeyEvent.Error -> HotkeyEvent.Error(message)
    }
